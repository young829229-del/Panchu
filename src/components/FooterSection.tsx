    ...
    <>
      <footer className={`w-full py-12 px-6 md:px-12 border-t transition-colors duration-300 ${
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          {/* Legal / Policy Links & Social / Contact Info - Social placed downside of terms */}
          <div className="flex flex-col items-center md:items-end gap-3 text-xs font-montserrat font-semibold uppercase tracking-widest w-full md:w-auto">
            
            {/* Legal & Policy Links - One Horizontal Line */}
            <div className="flex items-center justify-center flex-wrap sm:flex-nowrap gap-x-2.5 md:gap-x-3.5 whitespace-nowrap">
              <button
            ...
            <div className="flex items-center justify-center md:justify-end gap-4 shrink-0 pt-0.5">
              {/* TikTok */}
              <a
